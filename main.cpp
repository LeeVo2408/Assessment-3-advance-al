...
TEST(MstBoruvkaTest, smallRandomEuclidean) {
  ...
  Graph mst = boruvkaMST(G);
  EXPECT_NEAR(mst.edgeWeightSum(), 29.52429828536199, 0.00001);
}
...
TEST(MstBoruvkaTest, smallRandomEuclidean2) {
  ...
  Graph G = randomEuclideanGraph(N, numEdges, seed);
  Graph mst = boruvkaMST(G);
  EXPECT_NEAR(mst.edgeWeightSum(), 59.098762290261007, 0.00001);
}
...
TEST(MstBoruvkaTest, mediumRandomEuclidean) {
  ...
  Graph G = randomEuclideanGraph(N, numEdges, seed);
  Graph mst = boruvkaMST(G);
  EXPECT_NEAR(mst.edgeWeightSum(), 13315.932367669795, 0.00001);
}
...
TEST(MstBoruvkaTest, largeRandomEuclidean) {
  ...
  Graph G = randomEuclideanGraph(N, numEdges, seed);
  Graph mst = boruvkaMST(G);
  EXPECT_NEAR(mst.edgeWeightSum(), 114444.10921709349, 0.00001);
}
...
TEST(MstBoruvkaTest, largeSparseRandomEuclidean) {
  ...
  Graph G = randomEuclideanGraph(N, numEdges, seed);
  Graph mst = boruvkaMST(G);
  EXPECT_NEAR(mst.edgeWeightSum(), 339061.30473209539, 0.00001);
}
...
TEST(MstTest, 100KVertices) {
  ...
  Graph G = randomEuclideanGraph(N, numEdges, seed);
  Graph mst = boruvkaMST(G);
  EXPECT_NEAR(mst.edgeWeightSum(), 852787867.6233741, 0.00001);
}
